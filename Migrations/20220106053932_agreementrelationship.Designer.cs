...
namespace Bkash_Service_API.Migrations
{
    ...
    [Migration("20220106053932_agreementrelationship")]
    partial class agreementrelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementResponse", b =>
                {
                    ...
                    b.Property<Guid>("BkashCreateRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BkashCreateRequestId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementRequest", b =>
                {
                    ...
                    b.Property<Guid?>("bkashCreateAgreementRequestId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("bkashCreateAgreementResponseId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("bkashCreateAgreementRequestId");

                    b.HasIndex("bkashCreateAgreementResponseId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementResponse", b =>
                {
                    ...
                    b.Property<Guid>("bkashExecuteAgreementRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("bkashExecuteAgreementRequestId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementResponse", b =>
                {
                    b.HasOne("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementRequest", "bkashCreateRequest")
                        .WithOne("bkashCreateAgreementResponse")
                        .HasForeignKey("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementResponse", "BkashCreateRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("bkashCreateRequest");
                });

            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementRequest", b =>
                {
                    b.HasOne("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementRequest", "bkashCreateAgreementRequest")
                        .WithMany()
                        .HasForeignKey("bkashCreateAgreementRequestId");

                    b.HasOne("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementResponse", null)
                        .WithOne("bkashExecuteAgreementRequest")
                        .HasForeignKey("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementRequest", "bkashCreateAgreementResponseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("bkashCreateAgreementRequest");
                });

            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementResponse", b =>
                {
                    b.HasOne("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementRequest", "bkashExecuteAgreementRequest")
                        .WithOne("bkashExecuteAgreementResponse")
                        .HasForeignKey("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementResponse", "bkashExecuteAgreementRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("bkashExecuteAgreementRequest");
                });

            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashCreateAgreementRequest", b =>
                {
                    b.Navigation("bkashCreateAgreementResponse");
                });
            ...
            modelBuilder.Entity("Bkash_Service_API.Models.Entities.Bkash.BkashExecuteAgreementRequest", b =>
                {
                    b.Navigation("bkashExecuteAgreementResponse");
                });
