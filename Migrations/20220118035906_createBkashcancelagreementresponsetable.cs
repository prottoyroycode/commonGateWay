...
{
    public partial class createBkashcancelagreementresponsetable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BkashCancelAgreementResponse",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BkashCancelAgreementResponse", x => x.Id);
                });
        }
